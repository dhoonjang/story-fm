 ...
 * 바뀌어도 이 순서는 남는다 — 쾰른은 흰 셔츠를 입어도 빨강·흰이고, 레알 마드리드·풀럼은 흰,
 * 유벤투스는 검이 대표색이다. 유채색을 앞세우려고 순서를 바꾸지 않는다. 실제로 같은 구성인
 * 구단(유벤투스·우디네세의 흑백, 풀럼·발렌시아의 흰·검, 붉은 구단 여럿)은 현실처럼 문장의
 * 모양·글자·강조색으로 갈리고, 세 값을 전부 같이 갖는 구단은 둘이 없다 — `crest.test.ts`가
 * 잰다. 공식 값이 겹치는 빨강(쾰른·레버쿠젠의 순빨강)은 그 구단의 공식 출처가 든 다음
 * 값으로 갈린다.
 *
 * 띠(`band`)는 여기 없다 — 카탈로그가 리그 안에서 서로 갈리게 재어 붙인다
 * (`team-catalog.ts` `withBands` · ui/design-system.md §2).
 *
...
export const CLUB_COLOURS: Readonly<Record<string, ClubColours>> = {
  // ── 프리미어리그 ──
  arsenal: { primary: "#e30613", secondary: "#ffffff", accent: "#e30613" }, // 빨강·흰 — 공식 사이트 CSS --arsenal-red · https://www.arsenal.com/_next/static/css/926766ecf9284f82.css
  ...
  manutd: { primary: "#da020e", secondary: "#ffffff", accent: "#da020e" }, // 빨강·흰 반바지(검 양말) — 공식 엠블럼 SVG fill; 노랑 #ffe500은 엠블럼 색 · https://upload.wikimedia.org/wikipedia/en/7/7a/Manchester_United_FC_crest.svg
  ...
  bournemouth: { primary: "#ea0029", secondary: "#000000", accent: "#ea0029" }, // 빨강·검 — 공식 사이트 CSS --primary-500·--secondary-500 (엠블럼 SVG는 #db181e) · https://www.afcb.co.uk/
  ...
  fulham: { primary: "#ffffff", secondary: "#000000", accent: "#e5231b" }, // 흰·검 / 엠블럼 빨강 — 공식 사이트의 인라인 엠블럼 SVG fill · https://www.fulhamfc.com/
  ...
  nottingham: { primary: "#cc0000", secondary: "#ffffff", accent: "#cc0000" }, // 가리발디 레드·흰 — 공식 사이트 CSS --primary-500 (엠블럼 SVG는 #dd0000) · https://www.nottinghamforest.co.uk/
  ...
  coventry: { primary: "#62b5e5", secondary: "#001489", accent: "#62b5e5" }, // 스카이블루·남색 — 공식 사이트 CSS --primary-500·--secondary-500 · https://www.ccfc.co.uk/
  ...
  realmadrid: { primary: "#ffffff", secondary: "#fcbf00", accent: "#fcbf00" }, // 흰 / 금(엠블럼 왕관) — 공식 엠블럼 SVG fill; 남색 #00529f · https://upload.wikimedia.org/wikipedia/en/5/56/Real_Madrid_CF.svg
  ...
  realsociedad: { primary: "#0058b1", secondary: "#ffffff", accent: "#0058b1" }, // 파랑·흰(txuri-urdin) — 공식 사이트 theme-color·CSS · https://www.realsociedad.eus/
  espanyol: { primary: "#0085cc", secondary: "#ffffff", accent: "#0085cc" }, // 파랑·흰(blanquiazul) — 공식 엠블럼 SVG 방패 fill · https://www.rcdespanyol.com/assets/images/logo/emblem.svg
  ...
  bologna: { primary: "#c52833", secondary: "#2e2b54", accent: "#c52833" }, // 적청(rossoblù) — 빨강·남색, 공식 사이트 CSS (엠블럼 SVG는 #9f1f33·#1b2838) · https://web.archive.org/web/2022/https://www.bolognafc.it/wp-content/themes/bolognafc/css/styles.css
  ...
  sassuolo: { primary: "#1ba450", secondary: "#000000", accent: "#1ba450" }, // 흑녹(neroverdi) — 초록·검정, 공식 엠블럼 SVG fill · https://www.sassuolocalcio.it/wp-content/uploads/base/sassuolo-calcio-v.svg
  ...
  monza: { primary: "#e10032", secondary: "#ffffff", accent: "#e10032" }, // 빨강(Rosso Monza)·흰(biancorossi) — 공식 사이트 theme-color·--main-color · https://www.acmonza.com/
  // ── 분데스리가 ──
  ...
  leipzig: { primary: "#dd0741", secondary: "#ffffff", accent: "#dd0741" }, // 빨강·흰 — 공식 엠블럼 SVG (사이트 인라인 CSS의 빨강 #d2003c는 토큰 셋뿐) · https://www.fotmob.com/teams/178475/overview/rb-leipzig
  ...
  leverkusen: { primary: "#ff0000", secondary: "#000000", accent: "#ff0000" }, // 빨강·검 — 공식 사이트 CSS · https://www.bayer04.de/apple-touch-icon-180x180.png
  ...
  unionberlin: { primary: "#e30613", secondary: "#ffffff", accent: "#ffdd00" }, // 빨강·흰 / 노랑(엠블럼) — 공식 사이트 CSS --theme-primary·--theme-accent; 빨강·흰은 아스널과 같은 값이라 노랑이 가른다 · https://www.fc-union-berlin.de/
  ...
  koln: { primary: "#e60101", secondary: "#ffffff", accent: "#e60101" }, // 빨강·흰 (엠블럼 검) — 공식 사이트 CSS --color-brand-red-2; 첫 토큰 `red`는 레버쿠젠과 같다 · https://fc.de/icons.svg
  werder: { primary: "#007642", secondary: "#ffffff", accent: "#007642" }, // 초록·흰 — 공식 사이트 CSS --primary (#008149는 끼워 넣은 외부 위젯의 색) · https://web.archive.org/web/20260305/https://www.werder.de/
  ...
  elversberg: { primary: "#c8b885", secondary: "#141414", accent: "#c8b885" }, // 금·검·흰 — 공식 사이트 CSS --primary·--secondary · https://www.sv07elversberg.de/
  paderborn: { primary: "#1b5ca6", secondary: "#000000", accent: "#1b5ca6" }, // 파랑·검 — 공식 사이트 CSS (엠블럼 SVG는 #1963b8) · https://www.scp07.de/
  // ── 리그 1 ──
  ...
  lille: { primary: "#e41b13", secondary: "#211e5f", accent: "#e41b13" }, // 빨강·남색 — 공식 사이트 CSS --c-losc-red·--c-losc-blue (흰은 원정) · https://www.losc.fr/
  ...
  strasbourg: { primary: "#004996", secondary: "#ffffff", accent: "#009fe3" }, // 파랑·흰 / 하늘색 줄 — 공식 사이트 로고 SVG fill · https://www.rcstrasbourgalsace.fr/wp-content/uploads/2019/06/Racing_Club_de_Strasbourg_Alsace_RC_Strasbourg_-_RCS_-_RCSA_logo_officiel.svg
  ...
  nice: { primary: "#e30613", secondary: "#000000", accent: "#e30613" }, // 빨강·검(·금) — 공식 사이트 로고 SVG fill (CSS #e3051a) · https://www.ogcnice.com/
  troyes: { primary: "#003169", secondary: "#ffffff", accent: "#003169" }, // 파랑·흰 — 공식 사이트 CSS 프리셋; 밝은 파랑 #006bb3은 출처가 없어 뺐다 · https://www.estac.fr/
