 ...
 *
 * **대표색(`primary`)은 팀마다 유일하다.** 화면이 구단을 가르는 자리에 서는 색이라 두 팀이
 * 같은 값을 갖지 않는다 — 킷의 첫 색이 흰·검인 구단은 두 번째 공식 유채색이 `primary`에
 * 서고 흰·검은 `secondary`로 내려간다(레알 마드리드의 금, 토트넘의 남색). 유채색이 없는
 * 구단(유벤투스)만 무채색이 대표색이다. 공식 값이 겹치는 빨강(쾰른·레버쿠젠의 순빨강)은
 * 그 구단의 공식 출처가 든 다음 값으로 갈린다. `crest.test.ts`가 잰다.
 *
...
export const CLUB_COLOURS: Readonly<Record<string, ClubColours>> = {
  // ── 프리미어리그 ──
  arsenal: { primary: "#e20613", secondary: "#ffffff", accent: "#e20613" }, // 빨강·흰 · https://resources.premierleague.com/premierleague/badges/t3.svg
  ...
  fulham: { primary: "#e5231b", secondary: "#000000", accent: "#e5231b" }, // 엠블럼 빨강 / 흰·검 킷 · https://resources.premierleague.com/premierleague/badges/t54.svg
  everton: { primary: "#00009e", secondary: "#ffffff", accent: "#00009e" }, // 로열블루·흰 · https://www.brandcolorcode.com/everton
  leeds: { primary: "#0058a2", secondary: "#ffffff", accent: "#ffdf00" }, // 파랑 / 흰 킷·노랑 · https://www.brandcolorcode.com/leeds-united
  ...
  tottenham: { primary: "#000a3c", secondary: "#ffffff", accent: "#000a3c" }, // 남색 / 흰 킷 · https://resources.premierleague.com/premierleague/badges/t6.svg
  ...
  realmadrid: { primary: "#febe10", secondary: "#ffffff", accent: "#febe10" }, // 금(엠블럼 왕관) / 흰 킷·남색 #00529f · https://logos-world.net/real-madrid-logo/
  ...
  rayo: { primary: "#e21921", secondary: "#ffffff", accent: "#e21921" }, // 빨강 사선(franja roja) / 흰 킷 · https://www.thesportsdb.com/api/v1/json/3/searchteams.php?t=Rayo%20Vallecano
  valencia: { primary: "#ff671f", secondary: "#000000", accent: "#ff671f" }, // 주황(엠블럼) / 흰·검 킷 · https://web.archive.org/web/2026/https://www.valenciacf.com/assets/front-css.css
  ...
  sevilla: { primary: "#d10000", secondary: "#ffffff", accent: "#d10000" }, // 빨강(엠블럼 좌측·소매) / 흰 킷 · https://sevillafc.es/favicon/android-chrome-512x512.png
  ...
  racing: { primary: "#45ac34", secondary: "#ffffff", accent: "#45ac34" }, // 초록(verdiblanco) / 흰 킷 · https://site.api.espn.com/apis/site/v2/sports/soccer/esp.1/teams
  ...
  udinese: { primary: "#9f804d", secondary: "#000000", accent: "#9f804d" }, // 금(엠블럼 테두리) / 흑백(bianconeri) 킷 · https://www.udinese.it/WebObjects/Udinese.woa/Contents/WebServerResources/img/logo-new.png
  ...
  venezia: { primary: "#ff6900", secondary: "#000000", accent: "#ff6900" }, // 주황 / 검 킷·초록(arancioneroverdi) · https://www.veneziafc.it/_next/static/chunks/14jogjydcd2bq.css
  ...
  unionberlin: { primary: "#e30613", secondary: "#ffffff", accent: "#e30613" }, // 빨강·흰 (엠블럼 노랑) — 공식 사이트 CSS --theme-primary · https://fanartikel.union-zeughaus.de/
  gladbach: { primary: "#7ab929", secondary: "#000000", accent: "#7ab929" }, // 초록 / 검·흰 킷 · https://shop.borussia.de/de-de
  ...
  lyon: { primary: "#0f23aa", secondary: "#ffffff", accent: "#0f23aa" }, // 파랑 / 흰 킷·빨강 · https://hac.football/assets/images/logo-clubs/ol.svg · https://teamcolorcodes.com/lyon-colors/
  marseille: { primary: "#0b61ac", secondary: "#ffffff", accent: "#0b61ac" }, // 파랑 / 흰 킷(·금) · https://www.om.fr/_next/static/immutable/media/logo-om-blue.32tlxxbh_ford.svg · https://simpdovtmiepsfii.public.blob.vercel-storage.com/team-logos/olympique-de-marseille-logo-digital-full-color-rgb.svg
  ...
  angers: { primary: "#b48b4b", secondary: "#000000", accent: "#b48b4b" }, // 금 / 검·흰 킷 · https://commons.wikimedia.org/wiki/File:Angers_Sporting_Club_de_l%27Ouest_logo.svg
