...
export const CLUB_PROFILES_SEED: Record<string, ClubProfile> = {
  ...
  astonvilla: { stadium: "빌라 파크", capacity: 42_657, commercialTier: 2 },
  everton: { stadium: "힐 디킨슨 스타디움", capacity: 52_888, commercialTier: 2 },
  leeds: { stadium: "엘런드 로드", capacity: 37_645, commercialTier: 2 },
  sunderland: { stadium: "스타디움 오브 라이트", capacity: 49_000, commercialTier: 3 },
  brighton: { stadium: "아멕스 스타디움", capacity: 31_800, commercialTier: 3 },
  fulham: { stadium: "크레이븐 코티지", capacity: 29_600, commercialTier: 3 },
  crystalpalace: { stadium: "셀허스트 파크", capacity: 25_486, commercialTier: 3 },
  nottingham: { stadium: "시티 그라운드", capacity: 30_404, commercialTier: 3 },
  brentford: { stadium: "지테크 커뮤니티 스타디움", capacity: 17_250, commercialTier: 4 },
  bournemouth: { stadium: "바이탈리티 스타디움", capacity: 11_307, commercialTier: 4 },
  ...
  hull: { stadium: "MKM 스타디움", capacity: 25_586, commercialTier: 4 },

  // ── 라리가 ──
  barcelona: { stadium: "캄 노우", capacity: 99_354, commercialTier: 1 },
  realmadrid: { stadium: "산티아고 베르나베우", capacity: 78_297, commercialTier: 1 },
  atletico: { stadium: "메트로폴리타노", capacity: 70_460, commercialTier: 1 },
  betis: { stadium: "베니토 비야마린", capacity: 60_720, commercialTier: 2 },
  athletic: { stadium: "산 마메스", capacity: 53_289, commercialTier: 2 },
  sevilla: { stadium: "라몬 산체스 피스후안", capacity: 43_883, commercialTier: 2 },
  valencia: { stadium: "메스타야", capacity: 48_600, commercialTier: 2 },
  realsociedad: { stadium: "레알레 아레나", capacity: 39_500, commercialTier: 3 },
  villarreal: { stadium: "에스타디오 데 라 세라미카", capacity: 23_500, commercialTier: 3 },
  celta: { stadium: "발라이도스", capacity: 29_000, commercialTier: 3 },
  ...
  getafe: { stadium: "콜리세움", capacity: 17_393, commercialTier: 4 },
  rayo: { stadium: "캄포 데 바예카스", capacity: 14_708, commercialTier: 4 },
  alaves: { stadium: "멘디소로차", capacity: 19_840, commercialTier: 4 },
  elche: { stadium: "마르티네스 발레로", capacity: 31_388, commercialTier: 4 },
  ...
  atalanta: { stadium: "게비스 스타디움", capacity: 24_950, commercialTier: 3 },
  ...
  elversberg: { stadium: "우르잘바흐", capacity: 10_000, commercialTier: 4 },
  ...
  monaco: { stadium: "스타드 루이 II", capacity: 18_523, commercialTier: 3 },
  ...
  strasbourg: { stadium: "스타드 드 라 메노", capacity: 26_109, commercialTier: 4 },
  ...
  brest: { stadium: "스타드 프랑시스-르 블레", capacity: 15_931, commercialTier: 4 },
  angers: { stadium: "스타드 레몽 코파", capacity: 18_752, commercialTier: 4 },
  lehavre: { stadium: "스타드 오세앙", capacity: 25_178, commercialTier: 4 },
  auxerre: { stadium: "스타드 아베-데샹", capacity: 21_379, commercialTier: 4 },
