...
import { addDays, dayOfWeek, diffDays, seasonYear, squadReturnOf } from "./calendar";
import { entrantsOf } from "./europe";
...
import { domesticCupEntrants, domesticStageMatches } from "./domestic-cup";
