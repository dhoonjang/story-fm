...
import { addDays, diffDays, windowOpenOn } from "./calendar";
import { pronenessValue, raiseProneness } from "./injury";
import { makeRng } from "./rng";
import { openInjury, playerById, teamName, pushNarrative, type GameState } from "./state";
