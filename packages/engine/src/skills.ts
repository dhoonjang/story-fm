...
import { addDays, diffDays, sortEntries, squadReturnOf } from "./calendar";
import { clampForm } from "./form";
import { canRegisterFor, registrationLine, squadRegistrationOf } from "./registration";
import { SCOUT_REPEAT_LIMIT, completedScoutReports } from "./scouting";
import { creditSettling, settlingAnchor, settlingOf } from "./settling";
import {
  assignmentsOf,
  groupOf,
  isInjured,
...
// ── 전술 적응도 (docs/design/tactics-familiarity.md) ──────
//
