...
export const AI_FITNESS = defineHarness({
  ...
  bands: [
    ...
    { metric: "우리와 상대의 피로 격차", role: "guard", max: 30, unit: "score", why: "체력·감각 격차와 같은 이유이되 폭이 넓다 — AI는 「지침」(50)에서 자리를 내주고 하네스의 감독 팀은 내주지 않으므로 **차이가 나는 것이 정상**이다. 이 가드가 잡는 것은 AI가 아예 쌓지 않는 경우(그때 격차는 우리 잔고 전부다)" },
