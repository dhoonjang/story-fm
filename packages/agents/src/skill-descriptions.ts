...
export const SKILL_CATALOG = [
  ...
  },
  {
    ...
    readOnly: false,
    description:
      "감독이 시장과 장부를 움직이는 지시를 했을 때 — 오퍼·상대 오퍼에 답·계약 확정·철회·재계약·해지·이적 리스트·이적 요청 답·되사기·임대 복귀·이적 예산·보드 요청·사재 출연·보너스·표값·감독직 수락·흥정·지원. " +
  ...
  },
  {
    ...
    readOnly: false,
    description:
      "협상 상대와 마주 앉아 감독의 말을 건넨다 — line은 감독의 말 원문이다. 상대의 답이 <reply>로 돌아오고, 그 답은 그 사람의 말로 장면에 옮기되 지어내지 않는다. " +
