...
export const SKILL_CATALOG = [
  ...
  },
  {
    ...
    description:
      ...
      '감독이 정하지 않고 맡긴 말("알아서 짜세요")은 그대로 넘기지 않는다 — 코치의 안을 장면으로 내놓고 감독이 못 박은 뒤에 그 말을 넘긴다. ' +
  ...
  },
  {
    ...
    description:
      ...
      "orders에 감독의 말을 원문 그대로 적는다 — 액수·상대를 대신 채우지 않는다. 조건(추가 영입·주장·등번호·바이아웃 조항·사이닝 보너스·주급 인상 조항·그 밖)도 오퍼·재계약에 실린다. 오퍼 전에는 deal_odds로 확률을 보고 감독과 값을 정한 뒤 넘긴다. 결과로 무엇이 걸렸고 무엇이 반려됐는지가 온다. " +
