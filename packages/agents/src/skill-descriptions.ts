...
export const SKILL_CATALOG = [
  ...
  },
  {
    ...
    description:
      ...
      "한 턴에 한 번 부른다. 결과로 무엇이 걸렸고 무엇이 반려됐는지가 온다. 반려된 대로 쓴다. " +
  ...
  },
  {
    ...
    description:
      ...
      "한 턴에 한 번 부른다. 조건(추가 영입·주장·등번호·바이아웃 조항·사이닝 보너스·주급 인상 조항·그 밖)도 오퍼·재계약에 실린다. 오퍼 전에는 deal_odds로 확률을 보고 감독과 값을 정한 턴에 부른다. 결과로 무엇이 걸렸고 무엇이 반려됐는지가 온다. " +
