...
export const SKILL_CATALOG = [
  ...
  },
  {
    ...
    description:
      ...
      "순위표에는 최근 5경기 폼이 함께 나온다. season을 주면 지나간 시즌 — 순위표는 그때의 최종 표, 일정은 결산에 남은 감독 팀의 경기뿐이다. " +
  ...
  },
  {
    ...
    readOnly: true,
    description:
      "구단 재정을 조회한다 — 잔고·이적 예산·주급 총액에 **영입 관문 넷**(주급 여력, 미지급 분할 회분, 부채와 동결선, 1년 안에 끝나는 계약 전원)이 함께 온다. " +
      '월간 재정 보고서(수입·지출 항목, 현금 순증과 장부 손익, 급여 비중, PSR 여유)와 진행 중인 이번 달 잠정 집계도 같이 오고, month를 주면 그 달 보고서만 본다("2026-08"). ' +
      "영입·재계약을 묻거든 오퍼를 넣어 보기 전에 이것부터 읽어라 — 주급 여력이 음수면 지금은 아무도 못 산다.",
  },
  {
    name: "scout_player",
    label: "스카우트 파견",
