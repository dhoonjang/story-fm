...
| ----------- | --------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| 심경        | `MoodFact[]` — 원인 + 수치 + 기간                   | 화면 · 그 선수와 있었던 일을 쓴 스킬의 `mood` 인자(잔향 — [llm/agents.md](llm/agents.md) §4-3) |
