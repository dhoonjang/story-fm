...
- **구단 경제 수준** = 리그 경제 수준 + (1 − 리그 경제 수준) × 브랜드 리프트
  (1등급 0.55 · 2 0.30 · 3 0.12 · 4 0.05) — `world/wages.ts`. 리그 경제 수준은
...
- 주급 예산에도 같은 축이 곱해진다 — **성적 등급 × 브랜드 규모 × 구단 경제 수준**
  이고 브랜드 쪽이 더 크게 가른다
  ([../simulation/transfer.md](../simulation/transfer.md) §8). 임금과 살림이 한
  눈금 위에 선다.
