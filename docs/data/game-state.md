...
| 엔티티                                | 무엇                                                                                                                                                                                                                                                                 | 정의                   |
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| `negotiations` `Negotiation`          | 진행 중 협상 — 영입·매각·재계약·임대(양방향) · 조건서(`terms`) · 개인 조건 합의(`personal`) · 이적료 합의(`feeAgreed`) · 자리마다의 테이블(`tables.club`·`tables.agent` — 인내·줄) · 조항 발동(`buyout`) · 위임장(`mandate` — 담당자·한도·되돌림, transfer.md §12-4) | `domain/records.ts`    |
