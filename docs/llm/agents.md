...
| 결산                    | 언제                                         | 누가                                           | 대상                                | 폭                                                                              |
| ----------------------- | -------------------------------------------- | ---------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------- |
| 훈련 (`training-rater`) | 시간이 흐른 뒤, 그 구간을 **한 묶음으로**    | 별도 호출 — 싼 자리                            | 그 구간에 훈련한 1군 (부상·정지 밖) | 전술 적응도 −1\~+3 · 자리 0\~2 · 능력치 **3\~6명**(감독 훈련 축이 정한다) 각 ±1 |
...
| 무엇                                    | 어디                                                                                        |
| --------------------------------------- | ------------------------------------------------------------------------------------------- |
| GM 턴 실행·라우팅                       | `packages/agents/src/gm.ts`                                                                 |
