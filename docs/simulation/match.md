...
읽는다. 뒤지면 던지고 앞서면 물러선다 — 55분부터 한 칸씩, 남은 시간이 없거나(72분) 두 골
뒤지면 템포·압박·라인까지 얹는다. 크기는 실측의 경기 상황 효과에 맞춘다: 한 골 앞선 팀의 xG는
...
경기 중 탭 셋: **경기**(실시간 판 + 쌓인 xG 계단선 + 팀 통계) · **팀**(전술판 + 명단,
우리/상대) · **대회**(순위표 + 옆 구장 + 다음 경기). 전술 6축은 전술판에만. 상대 쪽은 조작
...
- **시트가 지시의 증거다.** 걸린 시트 줄은 그 포인트의 문장과 함께 서고, 판에 닿지 못한
  줄도 그 옆에 선다 — 서는 것은 허락된 포인트의 줄뿐이다.
